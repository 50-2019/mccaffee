...
namespace Caffee
{
    class TableButton : Button
    {
        ...
        private void button1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            {
                InfoWarningError infoWarning = new InfoWarningError("Are you sure you want to delete this table?", "warning", "YES", "NO");
                if (infoWarning.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
